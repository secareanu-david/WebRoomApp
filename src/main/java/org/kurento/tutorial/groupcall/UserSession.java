...
public class UserSession implements Closeable {
  ...
  private WebRtcEndpoint selfPreviewEndpoint;
  private FaceOverlayFilter appliedFilter;

  public void createSelfPreview() {
    this.selfPreviewEndpoint = new WebRtcEndpoint.Builder(pipeline).build();
    this.incomingMedia.put(name, selfPreviewEndpoint);
    outgoingMedia.connect(selfPreviewEndpoint);
  }

  public WebRtcEndpoint getSelfPreviewEndpoint() {
    return selfPreviewEndpoint;
  }
  ...
  private FaceOverlayFilter filter;

  public boolean isMuted() { return muted; }
  public void setMuted(boolean muted) { this.muted = muted; }

  public void setAppliedFilter(FaceOverlayFilter filter) {
    this.appliedFilter = filter;
  }

  public MediaElement getAppliedFilter() {
